...
class ClassRoomRepositoryImpl @Inject constructor(
    ...
    override suspend fun getClassRoomQuestionDetail(postId: Int): QuestionDetailData {
        return ClassRoomMapper.mapperToQuestionDetailData(
            dataSource.getClassRoomQuestionDetail(
                postId
            )
        )
    }
    ...
    override suspend fun postClassRoomWrite(classRoomPostWriteItem: ClassRoomPostWriteItem): ClassRoomPostWriteData {
        return ClassRoomMapper.mapperToClassRoomPostWriteData(
            dataSource.postClassRoomWrite(
    ...
    override suspend fun postQuestionCommentWrite(questionCommentWriteItem: QuestionCommentWriteItem): QuestionCommentWriteData {
        return ClassRoomMapper.mapperToQuestionCommentWriteData(
            dataSource.postQuestionCommentWrite(
    ...
    override suspend fun putCommentUpdate(
        ...
        return ClassRoomMapper.mapperToCommentUpdateData(
            dataSource.putCommentUpdate(
                commentId,
